...
import static de.bernd_michaely.common.desktop.fx.collections.selection.SelectionChangeListener.SelectionChange.SelectionChangeType.SINGLE_DECREMENT;
...
public class ListSelectionHandlerImplTest
{
	...
	@Test
	public void testRemoveSelectedNotify()
	{
		...
		final var value = selectableList.remove(1);
